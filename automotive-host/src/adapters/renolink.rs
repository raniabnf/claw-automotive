...
impl RenolinkAdapter {
    ...
    pub fn new(windows_version: WindowsVersion) -> Self {
        ...
        Self {
            descriptor: AdapterDescriptor {
                adapter_id: format!("renolink-{suffix}"),
                tool_family: ToolFamily::Renolink,
                windows_version,
            ...
            launch_spec: ToolLaunchSpec {
                executable_name: "renolink.exe".to_string(),
                cli_args: Vec::new(),
                requires_user_session: true,
                expected_process_names: vec!["renolink.exe".to_string()],
...
impl VehicleToolAdapter for RenolinkAdapter {
