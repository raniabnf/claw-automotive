...
impl LexiaAdapter {
    ...
    pub fn new(windows_version: WindowsVersion) -> Self {
        ...
        Self {
            descriptor: AdapterDescriptor {
                adapter_id: format!("lexia-{suffix}"),
                tool_family: ToolFamily::Lexia,
                windows_version,
            ...
            launch_spec: ToolLaunchSpec {
                executable_name: "lexia.exe".to_string(),
                cli_args: Vec::new(),
                requires_user_session: true,
                expected_process_names: vec!["lexia.exe".to_string()],
...
impl VehicleToolAdapter for LexiaAdapter {
